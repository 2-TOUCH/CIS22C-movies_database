...
public:
    ...
    void printLeafs(void visit(ItemType&)) const { _printLeafs(visit, rootPtr); }
...
private:
    ...
    void _printLeafs(void visit(ItemType&), BinaryNode<ItemType>* nodePtr) const;
};
...
template<class ItemType>
void BinaryTree<ItemType>::_printLeafs(void visit(ItemType&), BinaryNode<ItemType>* nodePtr) const
{
    if (nodePtr)
    {
        ItemType item = nodePtr->getItem();
        _printLeafs(visit, nodePtr->getLeftPtr());
        _printLeafs(visit, nodePtr->getRightPtr());
